...
if __name__ == "__main__":
    import timeit
    print(timeit.timeit("main1(10000, 100000, 227000, 3, 2, 0, '', '', 0, 0)", setup="from __main__ import test", number=5))
    print(timeit.timeit("main2(10000, 100000, 227000, 3, 2, 0, '', '', 0, 0)", setup="from __main__ import test", number=5))